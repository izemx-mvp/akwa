...
const lines: ExportLine[] = [
  { ref: "AKW-ENG-5W30-001", name: "Huile moteur synthétique 5W-30 – 1L", category: "Huiles moteur", qty: 2400, unit: "Bidons 1L", unitPrice: 5.5, weightKg: 2160, volumeM3: 3.1, prep: "Prêt", container: 1, pallets: 4 },
  { ref: "AKW-ENG-10W40-006", name: "Huile moteur semi-synthétique 10W-40 – 5L", category: "Huiles moteur", qty: 800, unit: "Bidons 5L", unitPrice: 21, weightKg: 3600, volumeM3: 4.6, prep: "Prêt", container: 1, pallets: 5 },
  { ref: "AKW-ENG-15W40-010", name: "Huile moteur diesel 15W-40 – 20L", category: "Huiles moteur", qty: 180, unit: "Fûts 20L", unitPrice: 57.4, weightKg: 3240, volumeM3: 4.2, prep: "Prêt", container: 1, pallets: 4 },
  { ref: "AKW-ATF-D3-021", name: "ATF Dexron III – 1L", category: "Huiles transmission", qty: 1200, unit: "Bidons 1L", unitPrice: 4.75, weightKg: 1080, volumeM3: 1.6, prep: "En préparation", container: 1, pallets: 2 },
  { ref: "AKW-GEAR-80W90-031", name: "Gear Oil 80W-90 – 4L", category: "Huiles transmission", qty: 500, unit: "Bidons 4L", unitPrice: 18, weightKg: 1850, volumeM3: 2.4, prep: "Prêt", container: 1, pallets: 3 },
  { ref: "AKW-COOL-005", name: "Liquide de refroidissement -35 °C – 5L", category: "Fluides automobiles", qty: 600, unit: "Bidons 5L", unitPrice: 7, weightKg: 3150, volumeM3: 3.6, prep: "En préparation", container: 2, pallets: 4 },
  { ref: "AKW-COOL-006", name: "Antigel concentré G12+ – 20L", category: "Fluides automobiles", qty: 140, unit: "Fûts 20L", unitPrice: 38.5, weightKg: 2940, volumeM3: 3.3, prep: "Prêt", container: 2, pallets: 3 },
  { ref: "AKW-BRK-DOT4-011", name: "Liquide de frein DOT 4 – 500 ml", category: "Fluides automobiles", qty: 1000, unit: "Flacons 500ml", unitPrice: 3.9, weightKg: 560, volumeM3: 0.9, prep: "Prêt", container: 2, pallets: 1 },
  { ref: "AKW-PSF-013", name: "Fluide direction assistée – 1L", category: "Fluides automobiles", qty: 700, unit: "Bidons 1L", unitPrice: 4.35, weightKg: 630, volumeM3: 1.0, prep: "Prêt", container: 2, pallets: 1 },
  { ref: "AKW-GREASE-LT-007", name: "Graisse lithium multiusage – 5 kg", category: "Graisses", qty: 300, unit: "Seaux 5kg", unitPrice: 20.9, weightKg: 1560, volumeM3: 1.8, prep: "Attente fournisseur", container: 2, pallets: 2 },
  { ref: "AKW-ADD-INJ-040", name: "Nettoyant injecteur diesel – 300 ml", category: "Additifs & nettoyants", qty: 1500, unit: "Flacons", unitPrice: 2.35, weightKg: 520, volumeM3: 1.1, prep: "Attente fournisseur", container: 2, pallets: 1 },
  { ref: "AKW-WSH-016", name: "Liquide lave-glace -20 °C – 5L", category: "Fluides automobiles", qty: 900, unit: "Bidons 5L", unitPrice: 2.95, weightKg: 4550, volumeM3: 5.2, prep: "Prêt", container: 2, pallets: 5 },
];

const baseOrder: ExportOrder = {
  reference: "AKW-EXP-2026-0187",
  clientRef: "PO-ALG-0826-014",
  ...
  transport: "Maritime",
  paymentTerms: "50 % acompte / 50 % avant embarquement",
  etd: "18/08/2026",
  eta: "30/08/2026",
  carrier: "CMA CGM",
  ...
  totals: { goods: 52800, logistics: 2800, insurance: 850, freight: 4600, other: 0, total: 61050, paid: 30525 },
  weightKg: 25840,
  volumeM3: 61.4,
  lines,
  containers: [
  ...
  familyReadiness: [
    { name: "Huiles moteur", pct: 100 },
    { name: "Huiles transmission", pct: 92 },
    { name: "Fluides automobiles", pct: 88 },
    { name: "Graisses & additifs", pct: 62 },
  ],
  quality: [
    { name: "Contrôle quantitatif", state: "Validé" },
    { name: "Contrôle packaging", state: "En cours" },
    { name: "Étiquetage & pictogrammes SDS", state: "Validé" },
    { name: "Contrôle palettes", state: "À venir" },
    { name: "Documents export", state: "En cours" },
  ],
  checklist: [
    { label: "Quantités vérifiées", done: true },
    { label: "Viscosités et normes conformes (API / ACEA)", done: true },
    { label: "Étiquettes validées", done: true },
    { label: "SDS & fiches techniques jointes", done: true },
  ...
  timeline: [
    ...
    { date: "03 août 2026", title: "Acompte reçu", detail: "30 525 € reçus.", state: "done" },
    { date: "04 août 2026", title: "Approvisionnement lancé", detail: "Commandes fournisseurs confirmées.", state: "done" },
    { date: "10 août 2026", title: "78 % des marchandises disponibles", detail: "Conditionnement et palettisation en cours au dépôt de Casablanca.", state: "current" },
  ...
  documents: [
    ...
    { id: "d6", name: "SDS – Fiches de données de sécurité", reference: "SDS-2026-0187", date: "06/08/2026", status: "Disponible", category: "Export" },
    { id: "d7", name: "Fiches techniques produits (TDS)", reference: "TDS-2026-0187", date: "06/08/2026", status: "Disponible", category: "Export" },
    { id: "d12", name: "Certificate of Analysis", reference: "COA-2026-0187", date: null, status: "À venir", category: "Export" },
    { id: "d13", name: "Certificat de conformité produit", reference: "PCC-2026-0187", date: null, status: "À venir", category: "Export" },
  ...
  payments: [
    { id: "pay1", date: "02/08/2026", label: "Facture proforma émise", amount: 61050, state: "done" },
    { id: "pay2", date: "04/08/2026", label: "Acompte 50 % reçu", amount: 30525, state: "done", meta: "Virement — Attijariwafa Bank" },
    { id: "pay3", date: "16/08/2026", label: "Solde attendu", amount: 30525, state: "pending", meta: "Avant embarquement" },
  ],
  instructions: [
    { id: "i1", text: "Merci de renforcer le filmage et le cerclage des palettes de bidons 5L.", createdAt: "05/08/2026", status: "Appliquée", handler: "Yassine Bennani" },
    { id: "i2", text: "Merci d'apposer les étiquettes en français avec pictogrammes SDS conformes au marché ivoirien.", createdAt: "06/08/2026", status: "En cours", handler: "Sofia El Mansouri" },
  ...
  messages: [
    { id: "m1", author: "Abidjan Lubricants Group", side: "client", at: "05 août 10:24", text: "Pouvez-vous confirmer que les bidons 5L seront livrés sur palettes cerclées ?", category: "Qualité" },
    { id: "m2", author: "Sofia El Mansouri — AKWA", side: "akwa", at: "05 août 10:42", text: "Oui, double cerclage et coiffe carton prévus pour les palettes de bidons.", category: "Qualité" },
    { id: "m3", author: "Abidjan Lubricants Group", side: "client", at: "08 août 14:15", text: "Merci. Pouvez-vous également m'envoyer le draft du certificat d'origine ?", category: "Documents" },
  ...
  decisions: [
    ...
    { id: "dec2", title: "Validation packaging", description: "Double cerclage + filmage renforcé sur les palettes de bidons d'huile moteur.", due: "12 août 2026", status: "En attente" },
    { id: "dec3", title: "Autoriser produit substitut", description: "Graisse lithium 5 kg indisponible chez le fournisseur principal — substitution proposée par une graisse lithium complexe équivalente (NLGI 2).", due: "11 août 2026", status: "En attente" },
  ],
  alerts: [
    { id: "a1", level: "Urgent", title: "Solde à régler avant embarquement", message: "Le solde de 30 525 € doit être réglé avant le 16 août afin de confirmer l'embarquement.", action: { label: "Voir paiement", tab: "paiements" } },
    ...
    { id: "a3", level: "Attention", title: "Produit en attente fournisseur", message: "Graisse lithium 5 kg : substitution proposée, votre accord est requis.", action: { label: "Voir les articles", tab: "articles" } },
  ...
  audit: [
    ...
    { at: "09 août 2026 – 11:15", action: "Quantité ATF Dexron III 1L modifiée", from: "1 100 unités", to: "1 200 unités", user: "Sofia El Mansouri" },
    ...
    { at: "04 août 2026 – 10:31", action: "Acompte encaissé", to: "30 525 €", user: "Comptabilité AKWA" },
