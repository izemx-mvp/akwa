...
const seedRules: PricingRule[] = [
  mk({
    id: "PR-2026-001",
    name: "Offre Fluides Afrique de l'Ouest",
    ...
    tags: ["Promotion", "Fluides automobiles", "Afrique de l'Ouest"],
    type: "remise_pct", value: 7, priority: 50, cumulative: false, minMargin: 15,
    scope: { ...emptyScope(), categories: ["Fluides automobiles"] },
  ...
  mk({
    ...
    scope: { ...emptyScope(), categories: ["Huiles moteur"] },
  ...
  mk({
    id: "PR-2026-005",
    name: "Prix spécial Huile moteur 5W-30 1L – VIP",
  ...
  mk({
    id: "PR-2026-006",
    name: "Remise par volume – Huiles transmission",
  ...
  mk({
    id: "PR-2026-007",
    name: "Promotion Additifs été 2026",
    description: "Remise de 6 % sur les additifs et nettoyants — campagne estivale terminée.",
    tags: ["Promotion", "Additifs"],
    type: "remise_pct", value: 6, priority: 45, cumulative: true, minMargin: 15,
    scope: { ...emptyScope(), categories: ["Additifs & nettoyants"] },
    audience: { ...emptyAudience(), allClients: true },
  ...
  mk({
    ...
    scope: { ...emptyScope(), categories: ["Fluides automobiles", "Graisses"] },
  ...
  mk({
    id: "PR-2026-010",
    name: "Brouillon – Remise Graisses grands comptes",
...
const seedCampaigns: Campaign[] = [
  {
    id: "CMP-2026-01",
    name: "Campagne Fluides Afrique de l'Ouest",
...
const seedBatches: PriceBatch[] = [
  {
    ...
    scopeLabel: "Catégorie Huiles moteur",
    restored: false,
    entries: [
      { ref: "AKW-ENG-5W30-001", name: "Huile moteur synthétique 5W-30 – 1L", from: 5.25, to: 5.5 },
      { ref: "AKW-ENG-5W40-004", name: "Huile moteur synthétique 5W-40 – 5L", from: 23.1, to: 24.1 },
    ],
  },
];
