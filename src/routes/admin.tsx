...
import { LayoutDashboard, ShoppingCart, Tag, BarChart3, Package, Ship, Bot, MessageSquare, Settings, Users, Database } from "lucide-react";
...
const nav: NavItem[] = [
  ...
  { to: "/admin/knowledge", label: "Base de Connaissance", icon: Database },
